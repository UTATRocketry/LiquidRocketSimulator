...
def houbolt_jr_single(inp_path):
    ...
    inp_dic_w = {}
    inp_dic_w["engine name"]    = input.engine.name        # Engine name
    inp_dic_w["engine Mfg"]     = input.engine.Mfg               # Engine manufacturer
    inp_dic_w["engine file"]    = input.engine.engfile 

    outfile_name = "single_output.txt"
    with open(outfile_name, "w") as outfile:
        json.dump(inp_dic_w, outfile)
